...
export const sessionsApi = {
  ...
  rollbackReview: (session: SessionRef, snapshotId: string, machineId = "local") => request(sessionPath(session, "review/rollback", machineId), parseRollbackReviewResponse, { method: "POST", body: sessionBody(session, { snapshotId }) }),

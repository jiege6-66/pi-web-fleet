...
export class PiWebApp extends LitElement {
  ...
  private readonly handleRollbackReview = (snapshotId: string): Promise<RollbackReviewChangeResult> => {
    return this.sessions.rollbackReview(snapshotId);
  };
